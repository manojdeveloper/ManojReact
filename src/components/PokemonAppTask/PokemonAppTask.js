...
export let PokemonAppTask = () => {
    ...
    let itemsPerPage = 4,
        ...
        paginationData = pokemon.slice(startIndex, endIndex);
    ...
    let filteredUsers = paginationData.filter((user) => {
            ...
            <div className="pokemonSection">
                <div className="pokemonContainer">
                    ...
                    <div className="nextPrevButton">
                        <button type="button" disabled={startIndex == 0} onClick={clickPrev}>Prev</button>
                        <button type="button" disabled={endIndex == pokemon.length} onClick={clickNext}>Next</button>
                    </div>
